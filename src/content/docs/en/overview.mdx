...
3. **Use transforms for repeated patterns.**
   ...
   transform that matches the content. Lotus enables both automatically.
...
Lotus users usually start at step 2 because the theme already configures the
markdown transforms, Iconify preload middleware, and shared styles.
