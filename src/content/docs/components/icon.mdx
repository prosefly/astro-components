...
Register the `proseflyComponents()` integration when a standalone Astro project needs
...
<Callout type="note" title="Prosefly theme defaults">
  ...
  static icon names. Theme projects do not need another `proseflyComponents()` entry.
</Callout>
